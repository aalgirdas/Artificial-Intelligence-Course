...
def solve():
    ...
    return recursive_best_first_search(puzzle).solution()
    #return depth_first_tree_search(puzzle).solution() # expencive
    # return depth_first_graph_search(puzzle).solution() # expencive but final ; Does not get trapped by loops.
